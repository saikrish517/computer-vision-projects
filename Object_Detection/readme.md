...
This repository contains code for object detection using the YOLOv3 algorithm, maintained by Sai Krishna Dasari. YOLOv3 is a popular real-time object detection algorithm known for its speed and accuracy.
...
Sai Krishna Dasari is an AI/ML Engineer and Data Scientist with experience in developing machine learning models, computer vision applications, and scalable AI pipelines. This project focuses on the practical implementation of real-time object detection systems.
