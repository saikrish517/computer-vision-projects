...
This repository hosts a collection of computer vision projects using deep learning techniques, focusing on various real-world applications. Maintained by Sai Krishna Dasari, each project is designed to demonstrate the power of transfer learning and convolutional neural networks (CNN) in solving practical problems. Here's what you'll find in this repository:
...
Sai Krishna is an AI/ML Engineer with over 4 years of experience developing machine learning models, scalable AI pipelines, and computer vision solutions. With a strong background in Python, TensorFlow, and PyTorch, he focuses on building production-ready artificial intelligence applications that support data-driven decision-making and operational efficiency.

- **LinkedIn:** https://www.linkedin.com/in/anarv-s-91811a173/
- **Email:** saikrishnadasari789@gmail.com
- **Key Skills:** Python, SQL, TensorFlow, PyTorch, Scikit-learn, AWS, MLOps